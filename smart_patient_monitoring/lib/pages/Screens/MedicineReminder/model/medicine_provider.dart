...
class MedicineProvider extends ChangeNotifier {
    ...
    void addMedicineModel (MedicineModel ? model) => MedicineReminderAPI.createMedicineModel(model);
    ...
    void updateModel (MedicineModel ? model) => MedicineReminderAPI.updateMedicineModel(model);
    void deleteModel (MedicineModel ? model) => MedicineReminderAPI.deleteMedicineModel(model);
}